...
try:
    ...
    from search import SearchEngine, SearchResult, TavilySearchEngine, get_search_engine  # type: ignore[no-redef]
...
class ResearchAgent:
    ...
    max_sources: int = 8
    search_engine: SearchEngine | TavilySearchEngine = field(default_factory=get_search_engine)
